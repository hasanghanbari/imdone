...
<div id="main">
	...
	<div id="content">
		...
		<div class="central-part">
			...
			<tr>
				...
				<td rowspan="6" valign="top">					
					...
					<div id="notes_admin_name" class="notes_container">
						<h4><?php echo lang_key('admin_name'); ?></h4>
						<p><?php echo lang_key('admin_name_info'); ?></p>
					</div>
			...
			<tr>
				<td>&nbsp;<?php echo lang_key('admin_name'); ?>&nbsp;</td>
				<td><input name="admin_name" id="admin_name" class="form_text" type="text" value="<?php echo $admin_name; ?>" onfocus="textboxOnFocus('notes_admin_name')" onblur="textboxOnBlur('notes_admin_name')" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> /></td>
			</tr>
