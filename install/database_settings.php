...
################################################################################
	...
	if($task == 'send'){
		...
		$folder_root		= isset($_POST['folder_root']) 		? prepare_input($_POST['folder_root']) : '';	
		$site_url			= isset($_POST['site_url']) 		? prepare_input($_POST['site_url']) : 'localhost';	
		...
		//	$error_msg = lang_key('alert_db_password_empty');
			...
			if(empty($error_msg)){
				...
				$_SESSION['folder_root'] 		= $folder_root;
		...
		$folder_root		= isset($_SESSION['folder_root']) ? $_SESSION['folder_root'] : '';
		$site_url			= isset($_SESSION['site_url']) ? $_SESSION['site_url'] : 'localhost';
		...
		<div class="central-part">
			...
			<tr>
				...
				<td rowspan="7" valign="top">					
					...
					<div id="notes_folder_root" class="notes_container">
						<h4><?php echo lang_key('folder_root'); ?></h4>
						<p><?php echo lang_key('folder_root_info'); ?></p>
					</div>
					<div id="notes_site_url" class="notes_container">
						<h4><?php echo lang_key('site_url'); ?></h4>
						<p><?php echo lang_key('site_url_info'); ?></p>
					</div>
			...
			<tr>
				<td nowrap>&nbsp;<?php echo lang_key('folder_root'); ?></td>
				<td>
					<input type="text" class="form_text" name="folder_root" value="<?php echo $folder_root; ?>" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> onfocus="textboxOnFocus('notes_folder_root')" onblur="textboxOnBlur('notes_folder_root')" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;<?php echo lang_key('site_url'); ?></td>
				<td>
					<input type="text" class="form_text" name="site_url" value="<?php echo $site_url; ?>" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> onfocus="textboxOnFocus('notes_site_url')" onblur="textboxOnBlur('notes_site_url')" />
				</td>
			</tr>
			<tr>
