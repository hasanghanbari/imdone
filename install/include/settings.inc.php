<?php
    ...
    define('EI_VERSION', '1.0.0');

    // *** default language: en - English
    define('EI_DEFAULT_LANGUAGE', 'fa');
    // *** default language direction: ltr - Left-To-Right (), rtl - Right-To-Left
    define('EI_DEFAULT_LANGUAGE_DIRECTION', 'rtl');
    ...
    $arr_active_languages = array(
        'fa'=>array('name'=>'فارسی', 'direction'=>'rtl'),
    ...
    define('EI_CONFIG_FILE_NAME', 'config.php');
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'تمام کردم');
    // *** version number of your application 
    define('EI_APPLICATION_VERSION', 'ورژن 1.0.0');
    
    // *** default start file name - application start file
    define('EI_APPLICATION_START_FILE', 'login');
