    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                ...
                <div class="d-flex">
                    <div class="w-100">
                        <h3 class="mb-4">صفحه عضویت</h3>
                    </div>
                </div>
                <form action="./action/admins/register" method="post" action="" class="signin-form">
                    <div class="form-group mt-3">
                        <input type="text" class="form-control" name="name" required>
                        <label class="form-control-placeholder" for="name">نام</label>
                    </div>
                    <div class="form-group mt-3">
                    ...
                    <div class="form-group">
                        <button type="submit" class="form-control btn btn-primary rounded submit px-3">عضویت</button>
                    </div>
